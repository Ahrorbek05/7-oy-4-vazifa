...
function Register() {
  return (
    <div className='max-w-96 mx-auto mt-28 p-8 rounded-lg shadow-xl'>
      ...
      <button className="btn btn-block mb-4 bg-blue-700 text-white mt-12">REGISTER</button>
      <span className='ml-[65px] flex gap-4'>
      <span> Already a member?</span><a href="/login" className='text-blue-600 hover:underline'>Login</a>
      </span>
    </div>
  )
}
